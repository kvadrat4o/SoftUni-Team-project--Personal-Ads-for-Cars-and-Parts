        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Avatar = table.Column<string>(maxLength: 350, nullable: true),
                    ConcurrencyStamp = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartNumber = table.Column<string>(maxLength: 15, nullable: true),
                    ...
                    TimesSold = table.Column<int>(nullable: false),
                    Title = table.Column<string>(maxLength: 130, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Cars_Model", x => x.Model);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Feedbacks_ProductId_SenderId", x => new { x.ProductId, x.SenderId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsInvoices", x => new { x.ProductId, x.InvoiceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsInvoices_InvoiceId",
